...
`.trim(),
  ...
  surface_capability: (
    ...
    [
      ...
      "After the primary user-facing artifact is renderable, open it once so the",
      "user can see the work. Opening is presentation only: it does not create,",
      "edit, attach, branch, or grant access to the artifact.",
