/**
 * The Grida brand mark.
 *
 * Theme-free per the package contract: the `<svg>` fills with `currentColor`,
 * so the consumer drives the color (`text-foreground`, `fill-*`, …). The
 * editor's re-export shim re-applies `fill-foreground` to reproduce the
 * historical look.
 */
const GridaLogo = ({
  className,
