...
/**
 * Remove-background tool glyph — a subject framed by a dashed/segmented crop
 * with a sparkle, signalling the AI cut-out. 24×24, `currentColor`.
 */
const RemoveBackgroundIcon = ({ ...props }: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
    ...
    >
      ...
      <path stroke="currentColor" strokeWidth="2" d="M18 22a6 6 0 0 0-12 0" />
      <path
        fill="currentColor"
