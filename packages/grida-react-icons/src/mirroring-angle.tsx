...
/**
 * Tangent-mirroring mode glyph — `Angle`: the two bezier handles share an angle
 * (colinear) but keep independent lengths. A vector-editing affordance with no
 * mainstream equivalent.
 *
 * Shape only: colors via `currentColor` (override with the `stroke` prop). 64×64.
 */
export default function MirroringAngleIcon({
  width = 64,
  height = 64,
  stroke = "currentColor",
