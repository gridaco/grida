...
export namespace MediaRoutes {
  export function imageModel(
    card:
      ...
      | null
      | undefined
  ): card is models.image.ImageModelCard & ModelCatalogView.Admission {
  ...
  export function videoModel(
    card:
      ...
      | null
      | undefined
  ): card is models.video.VideoModelCard & ModelCatalogView.Admission {
    return card?.listed === true;
  }
  export function image(
    card: models.image.ImageModelCard & ModelCatalogView.Admission,
  ...
  export function video(
    card: models.video.VideoModelCard & ModelCatalogView.Admission,
