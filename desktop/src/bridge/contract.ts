...
export const IPC_CHANNELS = {
  ...
  WINDOW_COMPLETE_ONBOARDING: "grida:window:complete-onboarding",
  ACCOUNT_SIGN_OUT: "grida:account:sign-out",
  ...
  ONBOARDING_WORKSPACE_DEFAULT: "grida:onboarding:workspace:default",
  ONBOARDING_WORKSPACE_CHOOSE: "grida:onboarding:workspace:choose",
  AGENT_FOCUS_SESSION: "grida:agent:focus-session",
  PROVIDER_ENDPOINT_SET: "grida:provider:endpoint:set",
  PROVIDER_ENDPOINT_DELETE: "grida:provider:endpoint:delete",
  PROVIDER_ENDPOINT_PROBE: "grida:provider:endpoint:probe",
  CHATGPT_CONNECT: "grida:chatgpt:connect",
  CHATGPT_CANCEL: "grida:chatgpt:cancel",
  CHATGPT_STATUS: "grida:chatgpt:status",
  CHATGPT_SIGN_OUT: "grida:chatgpt:sign-out",
