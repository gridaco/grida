...
vscode.commands.registerCommand("jupyter.showPreview", async function(uri) {
    try {
        ...
        const panel = vscode.window.createWebviewPanel('nbpreviewer', "Jupyter Notebook Previewer", vscode.ViewColumn.Two, { enableScripts: true, retainContextWhenHidden: true });
        panel.webview.html = `
            <style> 
                .vscode-dark { 
