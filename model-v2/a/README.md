...
| **ANIMATION**         | explicit-time SVG animation through the proving engine                          | **BOUNDED CHECKPOINT 2026-07-14** — [`engine/ANIMATION.md`](../engine/ANIMATION.md): accepted SVG Profiles 0/1 lower a retained rectangle subset into the existing effective-value/frame/cache path; exact-time offline rendering, a caller-owned playback clock, and a controlled native host are implemented. Browser/WPT differential evidence, animation replay, a compositor/product runtime, general SVG materialization, native Grida XML animation, and production migration remain pending                                                                                                                                                               |
