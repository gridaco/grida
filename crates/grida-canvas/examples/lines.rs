...
async fn demo_lines() -> Scene {
    ...
    root.base.name = "Lines Demo".to_string();
    root.size = Size {
        width: 1000.0,
        height: 600.0,
    };
    ...
    line_basic.base.name = "Basic".to_string();
    ...
    line_outside.base.name = "Outside".to_string();
    ...
    line_dashed.base.name = "Dashed".to_string();
    ...
    line_gradient.base.name = "Gradient".to_string();
    ...
    line_rotated.base.name = "Rotated".to_string();
