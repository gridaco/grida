...
async fn demo_images() -> (Scene, Vec<u8>) {
    ...
    rect2.stroke_style.stroke_width = 10.0;
    ...
    rect3.stroke_style.stroke_width = 10.0;
    ...
    rect4.stroke_style.stroke_width = 2.0;
    ...
    rect7.stroke_style.stroke_width = 2.0;
    ...
    rect8.stroke_style.stroke_width = 2.0;
    ...
    rect9.stroke_style.stroke_width = 2.0;
