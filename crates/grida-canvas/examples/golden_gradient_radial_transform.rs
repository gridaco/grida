...
fn main() {
    ...
    let radial_gradient = RadialGradientPaint {
        stops: vec![
            GradientStop {
                offset: 0.0,
                color: CGColor(200, 200, 200, 255), // Light gray center
            },
            GradientStop {
                offset: 0.9,
                color: CGColor(100, 100, 100, 255), // Medium gray
            },
            GradientStop {
                offset: 0.95,
    ...
    let data = image
        ...
        .expect("encode png");
    std::fs::write("goldens/gradient_radial_transform.png", data.as_bytes()).unwrap();
}
