...
use grida::painter::{Painter, PromotedBlit};
...
fn draw_layer_live(
    layer: &grida::painter::layer::PainterPictureLayer,
...
fn z_order_promoted_child_visible_above_container() {
    ...
    let mut promoted_blits: grida::cache::fast_hash::NodeIdHashMap<NodeId, PromotedBlit> =
        grida::cache::fast_hash::new_node_id_map();
