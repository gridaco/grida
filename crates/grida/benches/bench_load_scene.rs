...
//!
//! ```sh
//! cargo bench -p grida --bench bench_load_scene
//!
//! # Only flat_rects at all sizes:
//! cargo bench -p grida --bench bench_load_scene -- flat_rects
//!
//! # Only the 10k size:
//! cargo bench -p grida --bench bench_load_scene -- 10k
//!
//! # Only full load_scene (not per-stage):
//! cargo bench -p grida --bench bench_load_scene -- /load_scene
//! ```
