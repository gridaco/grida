...
//! cargo bench -p grida --bench bench_camera -- zoom
//!
//! # Run only the heavy scene:
//! cargo bench -p grida --bench bench_camera -- heavy
//!
//! # Run only pinch_zoom on heavy with compositing:
//! cargo bench -p grida --bench bench_camera -- heavy_compositing/pinch_zoom
//!
//! # Run only baseline config:
//! cargo bench -p grida --bench bench_camera -- baseline
//!
//! # Compare pan vs zoom for a specific config:
//! cargo bench -p grida --bench bench_camera -- heavy_compositing
//! ```
