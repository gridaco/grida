...
Text editing engine for the `grida` crate.
...
By inlining as a `grida` module, the editor can reference canvas types directly. No conversion, no data loss, no abstraction tax.
