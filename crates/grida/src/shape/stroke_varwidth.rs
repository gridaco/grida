...
///
/// ```rust
/// use grida::cg::varwidth::{VarWidthProfile, WidthStop};
/// use grida::shape::stroke_varwidth::create_variable_width_stroke;
///
...
/// ```rust
/// use grida::cg::varwidth::{VarWidthProfile, WidthStop};
/// use grida::shape::stroke_varwidth::create_variable_width_stroke_from_geometry;
...
///
/// ```rust
/// use grida::shape::stroke_varwidth::variable_width_stroke_geometry;
///
