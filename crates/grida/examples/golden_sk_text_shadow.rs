...
fn main() {
    ...
    let shadow1 = FeShadow {
        ...
        blur: 4.0,
        spread: 0.0,
        color: CGColor::from_rgba(0, 0, 0, 255), // Black
        active: true,
    };
    ...
    // save png
    dev_kit::save_golden(&mut surface, "sk_text_shadow");
}
...
fn draw_text_with_shadow(
    ...
    FONT.with(|font| {
        ...
        let text_shadow_filter = grida::painter::shadow::drop_shadow_image_filter(shadow);
