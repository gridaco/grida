...
cargo run -p grida --example skia_bench_<name> --features native-gl-context --release

# Examples:
cargo run -p grida --example skia_bench_effects --features native-gl-context --release
cargo run -p grida --example skia_bench_opacity --features native-gl-context --release
```
