...
//! `grida` crate stay invisible to example call sites.
//!
...
pub(crate) fn geist_typeface() -> Typeface {
    grida::embedded_fonts::typeface(grida::embedded_fonts::geist::BYTES)
}

/// `Typeface` for the embedded GeistMono font.
pub(crate) fn geistmono_typeface() -> Typeface {
    grida::embedded_fonts::typeface(grida::embedded_fonts::geistmono::BYTES)
}

pub(crate) use grida::embedded_fonts::geist::FAMILY as GEIST_FAMILY;
pub(crate) use grida::embedded_fonts::geistmono::FAMILY as GEISTMONO_FAMILY;
