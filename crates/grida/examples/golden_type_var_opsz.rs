...
fn main() {
    ...
    let mut surface = dev_kit::raster_surface(1200, 1800, Color::WHITE);
    ...
    dev_kit::save_golden(&mut surface, "type_var_opsz");
...
fn draw_text_example(
    ...
    // Create grida TextStyle with specific optical sizing
