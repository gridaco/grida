...
pub(crate) fn build() -> Scene {
    ...
    fn s_curve(x: f32, y: f32, profile: grida::cg::varwidth::VarWidthProfile) -> Node {
    ...
    let taper = s_curve(
        0.0,
        0.0,
        grida::cg::varwidth::VarWidthProfile {
            base: 3.0,
            stops: vec![
                grida::cg::varwidth::WidthStop { u: 0.0, r: 6.0 },
                grida::cg::varwidth::WidthStop { u: 1.0, r: 0.5 },
            ],
        },
    );
    ...
    let reverse_taper = s_curve(
        ...
        grida::cg::varwidth::VarWidthProfile {
            base: 3.0,
            stops: vec![
                grida::cg::varwidth::WidthStop { u: 0.0, r: 0.5 },
                grida::cg::varwidth::WidthStop { u: 1.0, r: 6.0 },
            ],
        },
    );
    ...
    let bulge = s_curve(
        ...
        grida::cg::varwidth::VarWidthProfile {
            base: 3.0,
            stops: vec![
                grida::cg::varwidth::WidthStop { u: 0.0, r: 1.0 },
                grida::cg::varwidth::WidthStop { u: 0.5, r: 8.0 },
                grida::cg::varwidth::WidthStop { u: 1.0, r: 1.0 },
            ],
        },
    );
    ...
    let multi_stop = s_curve(
        ...
        grida::cg::varwidth::VarWidthProfile {
            base: 3.0,
            stops: vec![
                grida::cg::varwidth::WidthStop { u: 0.0, r: 2.0 },
                grida::cg::varwidth::WidthStop { u: 0.25, r: 7.0 },
                grida::cg::varwidth::WidthStop { u: 0.6, r: 1.0 },
                grida::cg::varwidth::WidthStop { u: 1.0, r: 5.0 },
            ],
        },
    );
    ...
    let uniform = s_curve(
        ...
        grida::cg::varwidth::VarWidthProfile {
            base: 3.0,
            stops: vec![
                grida::cg::varwidth::WidthStop { u: 0.0, r: 3.0 },
                grida::cg::varwidth::WidthStop { u: 1.0, r: 3.0 },
            ],
        },
    );
