use super::*;
use grida::cg::stroke_width::RectangularStrokeWidth;
...
pub(crate) fn build() -> Scene {
    ...
    let c3 = Node::Container(ContainerNodeRec {
        ...
        stroke_style: StrokeStyle {
            ...
            stroke_dash_array: Some(grida::cg::stroke_dasharray::StrokeDashArray(vec![
                12.0, 6.0, 4.0, 6.0,
            ])),
        },
        stroke_width: StrokeWidth::Rectangular(RectangularStrokeWidth {
    ...
    let c4 = Node::Container(ContainerNodeRec {
        ...
        stroke_style: StrokeStyle {
            ...
            stroke_miter_limit: StrokeMiterLimit(4.0),
            stroke_dash_array: Some(grida::cg::stroke_dasharray::StrokeDashArray(vec![8.0, 4.0])),
        },
        stroke_width: StrokeWidth::Rectangular(RectangularStrokeWidth {
            stroke_top_width: 1.0,
            stroke_right_width: 3.0,
            stroke_bottom_width: 5.0,
