...
Raw FlatBuffers test fixtures live in [`fixtures/test-grida/`](../../fixtures/test-grida/) at the repo root. In-memory round-trip tests are in `cargo test --package grida --test fbs_roundtrip`. See the fixtures directory README for format and version details.
