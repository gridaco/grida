...
shell ships. The *model* — chords, virtual primary modifier,
...
- Every binding declares its **meaningful modifiers**: the modifiers
  ...
  held; meaningful-and-unlisted must be absent; *unmeaningful
  modifiers are don't-care* — the binding fires regardless of them.
...
which requires Mod *and* Ctrl absent, catches neither.
