use grida_cmath::{
    Rectangle, from_points, to_9points_chunk, contains, offset, intersection, union,
    rect_pad as pad, rect_inset as inset, rect_align as align, Alignment, AlignKind, get_relative_transform,
    rect_rotate, get_cardinal_point, CardinalDirection, axis_projection_intersection,
};
...
fn align_center() {
    let rects = [rect(10.0,10.0,30.0,40.0), rect(50.0,20.0,20.0,30.0)];
    let out = align(&rects, Alignment{horizontal:AlignKind::Center, vertical:AlignKind::Center});
