use grida_cmath::{Rectangle, RectangleSide, measure, guide_line_xylr, auxiliary_line_xylr};

fn rect(x:f32,y:f32,w:f32,h:f32)->Rectangle{Rectangle{x,y,width:w,height:h}}
