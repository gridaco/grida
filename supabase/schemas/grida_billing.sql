...
---------------------------------------------------------------------
-- [public.v_billing_credits]
-- GRIDA-EE: billing — passive cached-credit reads.
-- GRIDA-SEC-010 / GRIDA-SEC-012 — caller membership; no provider identifiers.
-- A direct member predicate anchors this statement's snapshot in addition
-- to existing organization/account RLS. Missing account rows remain explicit.
---------------------------------------------------------------------

CREATE OR REPLACE VIEW public.v_billing_credits
