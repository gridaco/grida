...
CREATE OR REPLACE VIEW "public"."dummy_with_user" AS
 SELECT "d"."id",
    "d"."created_at",
    "d"."text",
    "d"."user_id",
...
ALTER TABLE "public"."dummy_with_user" OWNER TO "postgres";
...
GRANT ALL ON TABLE "public"."dummy_with_user" TO "anon";
GRANT ALL ON TABLE "public"."dummy_with_user" TO "authenticated";
GRANT ALL ON TABLE "public"."dummy_with_user" TO "service_role";
