> text fixtures for testing and examples

## What's included?

Plain text samples used for layout, editing, and rendering tests. Header and footer attributions have been intentionally removed where applicable to keep fixtures focused on content.
...
- [Project Gutenberg](https://www.gutenberg.org/) — Free eBooks (public domain)
