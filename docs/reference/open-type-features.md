...
| --------------- | --------------------------------------------------- | ------------------------------------------------ | ------------------ |
| `aalt`          | Access All Alternates                               | Provides access to all alternates in the font    | `a g y`            |
...
| `calt`          | Contextual Alternates                               | Context-sensitive alternate forms                | `th sh`            |
...
| `ordn`          | Ordinals                                            | Ordinal number forms                             | `1st 2nd`          |
