...
**Import pipelines:** HTML import (`crates/grida-canvas/src/import/html/`), SVG import (via usvg, `crates/grida-canvas/src/import/svg/`).
...
CSS properties that lack direct IR representation are converted via structural tree transforms during HTML import (`crates/grida-canvas/src/import/html/mod.rs`).
