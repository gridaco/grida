...
| [ChatGPT Subscription Provider Implementation Guide](./chatgpt-subscription-provider.md) | Implementation guide for using a user's eligible ChatGPT plan as a native OpenAI/Codex-backed model provider. Covers auth flow, credential custody, capability resolution, first-party gateway, OpenAI API-key/BYOK, Codex ACP, and media-generation boundaries.                                                                                                                                                                     |
