...
([README §Status](../../../packages/grida-svg-editor/README.md))
...
[Commands](../../../packages/grida-svg-editor/README.md#commands)
...
| --------- | ----------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| selection | `select`, `deselect`, `select_all`, `select_sibling`, `enter_scope`, `exit_scope`                                             | [§Commands](../../../packages/grida-svg-editor/README.md#commands)                     |
| mode      | `set_mode`                                                                                                                    | [§Modes](../../../packages/grida-svg-editor/README.md#modes)                           |
| property  | `set_property`, `preview_property`                                                                                            | [§Properties](../../../packages/grida-svg-editor/README.md#observation--properties)    |
| paint     | `set_paint`, `preview_paint`, `set_paint_from_gradient`                                                                       | [§Paint](../../../packages/grida-svg-editor/README.md#observation--paint-fill--stroke) |
| transform | `translate`, `nudge`, `resize_to`, `rotate`, `rotate_to`, `flatten_transform`, `align`                                        | [§Commands — transforms](../../../packages/grida-svg-editor/README.md#commands)        |
| structure | `reorder`, `remove`, `group`, `insert`, `insert_preview`                                                                      | [§Commands — structure](../../../packages/grida-svg-editor/README.md#commands)         |
| content   | `set_text`, `enter_content_edit`                                                                                              | [§Commands — content](../../../packages/grida-svg-editor/README.md#commands)           |
| file      | `load_svg`, `serialize_svg`                                                                                                   | [§External control](../../../packages/grida-svg-editor/README.md#external-control)     |
| cleanup   | `tidy`                                                                                                                        | [§Commands — cleanup](../../../packages/grida-svg-editor/README.md#commands)           |
| history   | `undo`, `redo`                                                                                                                | [§Commands — history](../../../packages/grida-svg-editor/README.md#commands)           |
| defs      | `defs.gradients.{list,get,upsert,remove,subscribe}` and `patterns / symbols / markers / clip_paths / masks / filters` mirrors | [§Defs](../../../packages/grida-svg-editor/README.md#observation--defs-resources)      |
