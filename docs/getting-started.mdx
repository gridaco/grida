...
<Title>Welcome to Grida</Title>

> Grida is a opensource framework for design, front-end development, serverless computing best fit for startup products.

## Quickstart

> this quickstart guide is based on Figma and Flutter.

Get the Figma Assistant plugin [here](https://www.figma.com/community/plugin/896445082033423994)
