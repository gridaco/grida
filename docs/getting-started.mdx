...
The second option is to import your desifn directly from Grida. First, visit [app.grida.co](https://app.grida.co).

You’ll see Getting started Page. Enter the URL of the design, hit Load.
