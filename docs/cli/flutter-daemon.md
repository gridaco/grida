---
title: Retired Flutter daemon command
description: The former Grida design-to-code CLI and its Flutter daemon command have been retired.
unlisted: true
format: md
---

# Retired Flutter daemon command
