...
export default function ReferrerPageTemplate({
  ...
  return (
    <ScreenRoot data-testid="west-referral-referrer-page">
      <ScreenMobileFrame>
        <ScreenScrollable>
          <main className="bg-background h-full flex flex-col">
            ...
            <Standard.Section className="py-4">
              <Card
                ...
                className="relative overflow-hidden rounded-[var(--radius)] border-0 p-0 gap-2"
              >
            ...
            {design.show_invitations && invitations.length > 0 && (
              <Standard.Section>
                <Card className="relative overflow-hidden rounded-[var(--radius)] py-2 border-0">
