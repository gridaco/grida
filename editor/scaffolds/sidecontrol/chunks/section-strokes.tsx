...
export function SectionStrokes({
  ...
  const {
    ...
    strokeTopWidth: node.stroke_top_width,
    strokeRightWidth: node.stroke_right_width,
    strokeBottomWidth: node.stroke_bottom_width,
    strokeLeftWidth: node.stroke_left_width,
    strokeAlign: node.stroke_align,
    strokeCap: node.stroke_cap,
    strokeJoin: node.stroke_join,
    strokeMiterLimit: node.stroke_miter_limit,
    strokeDashArray: node.stroke_dash_array,
    type: node.type,
  }));
