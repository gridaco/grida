...
import { svgToDataUri } from "./templates";
...
export function Presentation({
  ...
  // Prefer the page's precomputed thumbnail (kept in sync via `withSvg`);
  // fall back to encoding on demand for safety.
  const dataUri = current.thumbnailDataUri ?? svgToDataUri(current.svg);
