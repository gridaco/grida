      ...
      >
        <div className="flex flex-col items-start text-left">
          ...
          <p className="max-w-2xl text-sm md:text-base text-muted-foreground">
            ...
            Build admin panels, dashboards, and internal tools in minutes—not
            months. No code required, just connect and start building. Your
            data, visualized your way.
          </p>
          <motion.div
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <Link href={sitemap.links.cta}>
              <FancyButton
                ...
                iconPlacement="right"
              >
                <span>Connect your Supabase</span>
              </FancyButton>
            </Link>
          </motion.div>
        </div>
