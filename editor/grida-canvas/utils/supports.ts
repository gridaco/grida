...
const dom_supports: Record<NodeFeatureProperty, ReadonlyArray<NodeType>> = {
  ...
  border: ["container", "tray", "component", "instance", "image", "video"],
  children: ["container", "tray", "component", "instance"],
  stroke: ["vector", "line", "rectangle", "ellipse", "polygon", "star", "tray"],
  stroke_paints: [],
  strokeWidth: [
    "rectangle",
    "image",
...
const canvas_supports: Record<NodeFeatureProperty, ReadonlyArray<NodeType>> = {
  ...
  border: [],
  children: ["container", "tray", "component", "instance", "boolean"],
  stroke: [
    "container",
    "tray",
    "rectangle",
