/**
 * ⚠️ IMPORTANT: DO NOT MODIFY THIS FILE DIRECTLY
 *
 * This file is copied from microsoft/vscode and needs to be synced manually.
 * Any modifications should be made to the original source and then synced here.
 *
 * @fileoverview https://github.com/microsoft/vscode/blob/main/src/vs/base/common/keyCodes.ts
 * @license MIT
