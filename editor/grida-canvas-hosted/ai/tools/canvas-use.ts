...
export namespace canvas_use {
  export namespace llm {
    ...
    <tools>
    - platform_sys_tool_ai_fetch_preflight: fetch preflight information for the given URL.
    - platform_sys_tool_ai_image_model_cards: list the available image model cards. try to use cheapest one for low-effort generation.
  ...
  export namespace tools_spec {
    ...
    export const create_node_from_svg = tool({
      name: name_create_node_from_svg,
    ...
    export const create_node_from_image = tool({
      name: name_create_node_from_image,
  ...
  export namespace client_impls {
    ...
    export async function create_node_from_svg(
      editor: Editor,
      params: {
        svg: string;
      }
    ...
    export async function create_node_from_image(
      editor: Editor,
      params: {
        name?: string;
