...
const test_path_d = "M50 250 Q150 200 250 250 T450 250";

const test_svg = `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
...
describe("v0", () => {
  it("convert", () => {
    iosvg.v0.convert(test_svg);
  });
});

describe("path", () => {
  it("d", () => {
    iosvg.path.d(test_path_d);
  });
});
