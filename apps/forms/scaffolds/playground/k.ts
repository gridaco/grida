...
export const examples = [
  {
    ...
    template: {
      schema: {
        src: `${Env.web.HOST}/schema/examples/001-hello-world/form.json`,
      },
    },
  },
  {
    ...
    template: {
      schema: {
        src: `${Env.web.HOST}/schema/examples/002-iphone-pre-order/form.json`,
      },
    },
  },
  {
    ...
    template: {
      schema: {
        src: `${Env.web.HOST}/schema/examples/003-fields/form.json`,
      },
    },
  },
  {
    ...
    template: {
      schema: {
        src: `${Env.web.HOST}/schema/examples/004-job-application/form.json`,
      },
    },
  },
  {
    ...
    template: {
      schema: {
        src: `${Env.web.HOST}/schema/examples/005-logics/form.json`,
      },
    },
  },
  {
    ...
    template: {
      schema: {
        src: `${Env.web.HOST}/schema/examples/006-computed-fields/form.json`,
      },
    },
  },
  {
    ...
    template: {
      schema: {
        src: `${Env.web.HOST}/schema/examples/007-data-transform/form.json`,
      },
    },
  },
] as const;
