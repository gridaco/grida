...
const Album = () => {
  return <AlbumWrapper flexDirection='column'  >
    ...
    <span style={{ marginTop: 5, color: "#4a4a4a" }}>Morning Slowbeats -<br />LoFi</span>
...
const Music = () => {
  return <Flex alignItems="center" mb="20px" bg='#fff' style={{ boxShadow: "0px 6.90133px 41.408px 6.90133px rgba(111, 111, 111, 0.08)", borderRadius: 7 }}>
    <Box width="90px" height="90px" bg='#000' />
    <Flex flexDirection="column" height="100%" ml="10px">
      <h1 style={{ margin: 0, marginTop: 10, fontSize: 25 }}>TRIPPE</h1>
      <span style={{ marginTop: 5, fontSize: 15, color: "#4a4a4a" }}>Morning Slowbeats - LoFi</span>
    </Flex>
    <Icon name="play" ml="auto" mr="10px" />
  </Flex>
}
  ...
  return (
    <Wrapper flexDirection="column" px="30px">
      <Flex mt="25px" alignItems="center" justifyContent="space-between">
        ...
        <div style={{ width: 80, height: 80, backgroundColor: "#000", borderRadius: "50%" }} />
      </Flex>
      <Comment>Here are some tunes for you to start your morning. Mostly quiet and slow-beat, some of them are mood changer.</Comment>
      ...
      <Flex mt="25px" alignItems="flex-end" justifyContent="space-between">
        ...
        <div style={{ backgroundColor: "#CDC0FF", color: "#8465FF", padding: "3px 4px", borderRadius: 9 }}>NOW PLAYING</div>
      </Flex>
