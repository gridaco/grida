...
export default function SecrionOpensource1440SizeXl() {
  return (
    <RootWrapperSecrionOpensource1440SizeXl>
      <Top>
        <HeadingAndGraphicsContainer>
          <HeadingContainer>
            <TextArea>
              <Heading>
                You onw it.
              ...
              <Description>
                With our Opensource SDK, you have the deepest control of your
                workflow. Extend the logics, provide custom components, add
                backend logic middleware, statemanagement.
              </Description>
            </TextArea>
            <ActionLink>
              <BaseActionLink>
                <Frame245>
                  <Leading>
                    <IconsAntdGithubDefault
                      src="https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/c43f/a985/34e7238d3975ee0b05e5d534cc06e20b"
                      alt="icon"
                    ></IconsAntdGithubDefault>
                  </Leading>
                  <Label>View it on Github</Label>
          ...
          <Artwork>
            <DummyArtworkArtwork
              src="https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/137e/fa50/6387112e719a83859e004f309b8a4870"
              alt="image of DummyArtworkArtwork"
            ></DummyArtworkArtwork>
          </Artwork>
        </HeadingAndGraphicsContainer>
      </Top>
            ...
            <BaseVscodeTab>
              <LabelArea>
                <Icon
                  ...
                  alt="icon"
                ></Icon>
                <Label_0001>React.tsx</Label_0001>
              </LabelArea>
            </BaseVscodeTab>
            <BaseVscodeTab_0001>
              <LabelArea_0001>
            ...
            <BaseVscodeTab_0002>
              <LabelArea_0002>
                <Icon_0002
                  ...
                  alt="icon"
                ></Icon_0002>
                <Label_0003>Flutter.dart</Label_0003>
              </LabelArea_0002>
            </BaseVscodeTab_0002>
            <BaseVscodeTab_0003>
              <LabelArea_0003>
                <Icon_0003
                  ...
                  alt="icon"
                ></Icon_0003>
                <Label_0004>vanilla.html</Label_0004>
              </LabelArea_0003>
            </BaseVscodeTab_0003>
            <BaseVscodeTab_0004>
              <LabelArea_0004>
                <Icon_0004
                  ...
                  alt="icon"
                ></Icon_0004>
                <Label_0005>module.css</Label_0005>
              </LabelArea_0004>
            </BaseVscodeTab_0004>
          </Tabbar>
...
const RootWrapperSecrionOpensource1440SizeXl = styled.div`
  display: flex;
...
const HeadingAndGraphicsContainer = styled.div`
  display: flex;
...
const DummyArtworkArtwork = styled.img`
  width: 223px;
  height: 346px;
  object-fit: cover;
`;
