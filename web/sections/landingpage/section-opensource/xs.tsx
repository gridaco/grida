...
export default function SecrionOpensource320SizeXs() {
  return (
    <RootWrapperSecrionOpensource320SizeXs>
      <Top>
        <HeadingContainer>
          <Frame626>
            <TextArea>
...
const RootWrapperSecrionOpensource320SizeXs = styled.div`
  display: flex;
