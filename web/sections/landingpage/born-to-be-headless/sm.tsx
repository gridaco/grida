...
export default function SectionBornToBeHeadless768SizeSm() {
  return (
    <RootWrapperSectionBornToBeHeadless768SizeSm>
      <Frame623>
        <BornToBeHeadless>
          Born to be
          <br />
        ...
        <SwitchContainer>
          <Switches>
            ...
            <BaseTabFeaturedMenu_0004>
              {
                'The input design was not handled. "(base) tab-featured-menu" type of "undefined" - {"id":"7298:73037","originName":"(base) tab-featured-menu"}'
              }
            </BaseTabFeaturedMenu_0004>
            <BaseTabFeaturedMenu_0005>
              {
                'The input design was not handled. "(base) tab-featured-menu" type of "undefined" - {"id":"7298:73038","originName":"(base) tab-featured-menu"}'
              }
            </BaseTabFeaturedMenu_0005>
            <BaseTabFeaturedMenu_0006>
              {
                'The input design was not handled. "(base) tab-featured-menu" type of "undefined" - {"id":"7298:73039","originName":"(base) tab-featured-menu"}'
              }
            </BaseTabFeaturedMenu_0006>
          </Switches>
        </SwitchContainer>
...
const RootWrapperSectionBornToBeHeadless768SizeSm = styled.div`
  display: flex;
