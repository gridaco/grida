...
export default function SectionBornToBeHeadless1024SizeMd() {
  return (
    <RootWrapperSectionBornToBeHeadless1024SizeMd>
      <Frame623>
        <BornToBeHeadless>
        ...
        <SwitchContainer>
          <Switches>
            ...
            <BaseTabFeaturedMenu_0004>
              {
                'The input design was not handled. "(base) tab-featured-menu" type of "undefined" - {"id":"7298:72810","originName":"(base) tab-featured-menu"}'
              }
            </BaseTabFeaturedMenu_0004>
            <BaseTabFeaturedMenu_0005>
              {
                'The input design was not handled. "(base) tab-featured-menu" type of "undefined" - {"id":"7298:72811","originName":"(base) tab-featured-menu"}'
              }
            </BaseTabFeaturedMenu_0005>
            <BaseTabFeaturedMenu_0006>
              {
                'The input design was not handled. "(base) tab-featured-menu" type of "undefined" - {"id":"7298:72812","originName":"(base) tab-featured-menu"}'
              }
            </BaseTabFeaturedMenu_0006>
          </Switches>
        </SwitchContainer>
...
const RootWrapperSectionBornToBeHeadless1024SizeMd = styled.div`
  display: flex;
