...
export default function DesignOnceRunAnywhere1280SizeLg() {
  return (
    <RootWrapperDesignOnceRunAnywhere1280SizeLg>
      <Contents>
        <Spacer></Spacer>
...
const RootWrapperDesignOnceRunAnywhere1280SizeLg = styled.div`
  display: flex;
