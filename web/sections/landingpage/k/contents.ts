export const contents = {
  ...
  p_hero_description: `Grida is a Free and Open-source platform that will automatically transform your Figma design to developer-friendly code for Web & Mobile apps.`,
  // design_once_run_anywhere
  heading2_design_once_run_anywhere: "Design once, Run anywhere.",
  // everything_instant
  heading2_everything_instant: "Everything Instant.",
  p_everything_instant_description: `From entire frame to a single component, Grida responds to your click. The headless, light-weight workflow will make your work even faster. Make every step of your work instant.`,
  heading3_figma_onair: {
    figma: "Figma",
    onair: "ON AIR",
  },
  p_figma_onair_description: `Grida is solely dedicated to Figma platform to bring you the most advanced, responsive development experience ever. You will find everything you need to go on-air with Figma.`,
  action_how_does_design_to_code_work: "How does Design to code work?",
  action_try_the_demo: "Try the demo",
...
full control.`,
  ...
  heading2_see_the_magic: "See the magic",
  p_see_the_magic_description: "Supercharge you productivity with one click.",
};
