...
const BridgedSolutions = () => {
    return (
        <SolutionsWrapper alignItems="center" justifyContent="center">
            <Flex width={["320px", "730px", "985px", "1250px"]} alignItems="center" justifyContent="center" flexDirection="column">
                ...
                <Box width="100%" height="650px" mt="90px" mb="100px" style={{ position: "relative" }}>
                    <Box width="120%" height="650px" mt="90px" mb="100px" style={{
                        position: "absolute",
                        top: "-15%",
                        width: "calc(100 % + 20 %)",
                        left: "-10%"
